...
var _graphMetric = require('./graphMetric.js');

var _graphMetric2 = _interopRequireDefault(_graphMetric);
...
new Vue({
    ...
    ready: function ready() {
        ...
        this.$http.get(this.baseUrl).then(function (_ref) {
            var data = _ref.data;

            _this.availableMetrics = data.metrics;
            _this.metric = data.metrics[0];
            var app = document.getElementById("graph-container");
            var canvas = _this.createCanvas("myCanvas");
            app.appendChild(canvas);
            _this.updateMetric(canvas);
        });
    },
    ...
    methods: {
        updateMetric: function updateMetric() {
            var _this2 = this;

            var canvas = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];

            this.$http.get(this.baseUrl, { metric: this.metric.code }).then(function (_ref2) {
                var data = _ref2.data;
                return _this2.createChart(canvas, "line", data.data, { label: "Number Of Post" });
            });
        },
        createChartData: function createChartData(fetchedData) {
            var settings = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
            ...
            if (settings !== null && (typeof settings === 'undefined' ? 'undefined' : _typeof(settings)) === 'object') {
        ...
        createChart: function createChart(canvas) {
            var chartType = arguments.length <= 1 || arguments[1] === undefined ? "line" : arguments[1];
            var fetchedData = arguments[2];
            var settingObject = arguments[3];
            var options = arguments.length <= 4 || arguments[4] === undefined ? null : arguments[4];

            var chartData = this.createChartData(fetchedData, settingObject);
...
},{"./graphMetric.js":49,"chart.js":1,"vue":47,"vue-resource":46}],49:[function(require,module,exports){
'use strict';
...
var GraphMetric = Vue.extend({
    ...
    ready: function ready() {
        ...
        var panel = document.getElementById(this.randomId);
...
exports.default = Vue.component('graph-metric', GraphMetric);

},{"vue":47,"vue-resource":46}]},{},[48]);
