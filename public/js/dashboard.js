...
/***/ function(module, exports, __webpack_require__) {
	...
	var component = {
	    vuex: {
	        getters: {
	            allMetrics: function allMetrics(state) {
	                return state.metrics;
	            },
	            shownMetrics: function shownMetrics(state) {
	                return state.shownMetrics;
	            }
	        },
	        actions: {
...
/***/ function(module, exports) {
	...
	var getAllMetrics = function getAllMetrics(_ref2) {
	    var dispatch = _ref2.dispatch;
	
	    return this.$http.get('api/metrics').then(function (response) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container\">\n    <div class=\"panel-group\" id=\"accordion\" role=\"tablist\" aria-multiselectable=\"true\" v-for=\"metric in shownMetrics\">\n        <div class=\"panel panel-default\">\n            <div class=\"panel-heading\" role=\"tab\" :id=\"'heading'+$index\">\n                <h4 class=\"panel-title\">\n                    <a role=\"button\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapse{{$index}}\" aria-expanded=\"true\" aria-controls=\"collapse{{$index}}\">\n                        {{metric.label}}\n                    </a>\n                </h4>\n            </div>\n            <div id=\"collapse{{$index}}\" class=\"panel-collapse collapse\" :class=\"{'in':$index==0}\" role=\"tabpanel\" aria-labelledby=\"heading{{$index}}\">\n                <div class=\"panel-body\">\n                    {{metric.data}}\n                </div>\n            </div>\n        </div>\n    </div>\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
	    ...
	    UPDATEMETRICS: function UPDATEMETRICS(state, metrics) {
	        state.metrics = metrics;
	    },
	    UPDATESHOWNMETRICS: function UPDATESHOWNMETRICS(state, metrics) {
	        state.shownMetrics = metrics;
	    }
	};
	
	module.exports = new Vuex.Store({ state: state, mutations: mutations });
